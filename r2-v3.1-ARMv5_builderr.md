## Bug report of the released r2 v3.1.0
Tested r2 version/codeset: https://github.com/radare/radare2/tree/3.1.0
Issue xref: https://github.com/radare/radare2/issues/12334

1. Details of Tested Platform & OS: (worked with previous r2 version)
```
ARM5 32bit Emulated Debian 7 Wheezy (last updated)
```

2. Bug Symthoms:
```asm
Build error, CPU compatibiliy vs breakpoint ifdef
```
...
4. Possible source of error:
```
libr/include/r_util/r_sys.h
Line 93 to 94
```
<img src=https://i.imgur.com/goUl3gQ.png border=0 width=400>

5. Explanation:
```
Linux ARM/THUMB processor incompatible with the ifdef'ed breakpoint 
```

6. Suggested solution:
```asm
must figure a better way to define ARM5 CPU breakpoint flag in  libr/include/r_util/r_sys.h ifdef
```
7. Workaround: (use this ONLY until permanent fix is ready)
```asm
tweaking `libr/include/r_util/r_sys.h` by changing the `bkpt` value (worked)
```

8. Error Compile log: (was using older version for comparison/double-check)
```asm
$ sys/install.sh
WARNING: Updating from remote repository
[  223.192000] ipv6: Unknown symbol __ip4_datagram_connect (err 0)
[  223.192000] ipv6: Unknown symbol ip_idents_reserve (err 0)
[  223.192000] ipv6: disagrees about version of symbol tcp_alloc_md5sig_pool
[  223.192000] ipv6: Unknown symbol tcp_alloc_md5sig_pool (err -22)
remote: Enumerating objects: 7020, done.
remote: Counting objects: 100% (7020/7020), done.
remote: Compressing objects: 100% (22/22), done.
remote: Total 19505 (delta 7000), reused 7003 (delta 6998), pack-reused 12485
Receiving objects: 100% (19505/19505), 10.67 MiB | 1.87 MiB/s, done.
Resolving deltas: 100% (16251/16251), completed with 1459 local objects.
From https://github.com/radare/radare2
   8dff0e0..5cd427e  master     -> origin/master
 ...
 * [new branch]      fix-agc    -> origin/fix-agc
...
Fast-forward
 ...
 doc/images/r2w.svg                                 |   90 +
 doc/indent-example.c                               |   47 +
 doc/macos.md                                       |   46 +-
 doc/node.js/package.json                           |    6 +-
 doc/openbsd.md                                     |   41 +
 doc/plugins.md                                     |    2 +-
 ...
 doc/zsh/_rafind2                                   |    1 +
 doc/zsh/_ragg2                                     |    2 +-
 doc/zsh/_ragg2-cc                                  |   45 -
 doc/zsh/_rax2                                      |    2 +
 env.sh                                             |    2 +-
 global.mk                                          |    7 +-
 libr/Makefile                                      |  147 +-
 libr/anal/Makefile                                 |    7 +-
 libr/anal/anal.c                                   |  299 +-
 ...
 libr/anal/d/meson.build                            |    4 +-
 libr/anal/d/spec.sdb.txt                           |   15 +
 libr/anal/d/types-linux.sdb.txt                    |   76 +
 libr/anal/d/types-windows.sdb.txt                  |    9 +-
 libr/anal/d/types.sdb.txt                          |  602 +-
 libr/anal/data.c                                   |   62 +-
 libr/anal/diff.c                                   |   19 +-
 ...
 libr/anal/esil_trace.c                             |   28 +-
 libr/anal/fcn.c                                    | 1175 +-
 libr/anal/flirt.c                                  |   10 +-
 libr/anal/hint.c                                   |   54 +-
 libr/anal/labels.c                                 |   41 +-
 libr/anal/meson.build                              |  126 +-
 libr/anal/meta.c                                   |  224 +-
 libr/anal/op.c                                     |  226 +-
 libr/anal/p/Makefile                               |    4 +-
 libr/anal/p/anal_6502.c                            |  216 +-
 libr/anal/p/anal_8051.c                            |   36 +-
 libr/anal/p/anal_arc.c                             |    5 +-
 libr/anal/p/anal_arm_cs.c                          |  564 +-
 libr/anal/p/anal_arm_gnu.c                         |   20 +-
 libr/anal/p/anal_arm_hacks.inc                     |   21 +
 libr/anal/p/anal_avr.c                             |  311 +-
 libr/anal/p/anal_bf.c                              |    8 +-
 libr/anal/p/anal_chip8.c                           |    2 +-
 libr/anal/p/anal_cr16.c                            |    2 +-
 libr/anal/p/anal_cris.c                            |   29 +-
 ...
 libr/asm/arch/arm/armass.c                         | 6260 +++++-
 libr/asm/arch/arm/armass16_const.h                 |   33 +
 ...
 libr/asm/arch/include/xtensa-isa.h                 |  164 +-
 ...
 libr/asm/arch/pic/pic_midrange.c                   |  245 +
 libr/asm/arch/pic/pic_midrange.h                   |  103 +
 ...
 libr/asm/arch/ppc/libps/libps.h                    |    4 +-
 libr/asm/arch/ppc/libvle/vle.h                     |   12 +-
 libr/asm/arch/propeller/propeller_disas.c          |   14 +-
 libr/asm/arch/propeller/propeller_disas.h          |    2 +-
 ...
 libr/asm/arch/tms320/c55x_plus/c55plus_decode.c    |  127 +-
 ...
 libr/asm/arch/tms320/c55x_plus/ins.h               |    2 +-
 libr/asm/arch/tms320/tms320_dasm.c                 |  257 +-
 libr/asm/arch/tms320/tms320_dasm.h                 |    8 +-
 libr/asm/arch/tricore/gnu/cpu-tricore.c            |   33 +-
 libr/asm/arch/tricore/gnu/tricore-dis.c            | 1617 +-
 libr/asm/arch/v810/v810_disas.c                    |    9 +-
 libr/asm/arch/v810/v810_disas.h                    |    2 +-
 libr/asm/arch/v850/v850_disas.c                    |  121 +-
 libr/asm/arch/v850/v850_disas.h                    |  144 +-
 libr/asm/arch/vax/vax-dis.c                        |  129 +-
 libr/asm/arch/wasm/wasm.c                          |   73 +-
 libr/asm/arch/whitespace/wsdis.c                   |  176 +-
 libr/asm/arch/xtensa/gnu/elf32-xtensa.c            |    6 +-
 libr/asm/arch/xtensa/gnu/xtensa-dis.c              |  140 +-
 libr/asm/arch/xtensa/gnu/xtensa-isa.c              |  216 +-
 libr/asm/arch/xtensa/gnu/xtensa-modules.c          | 1724 +-
 libr/asm/arch/z80/z80.c                            |  292 +-
 libr/asm/arch/z80/z80_tab.h                        |  153 +
 libr/asm/asm.c                                     |  314 +-
 libr/asm/code.c                                    |    2 +-
 libr/asm/d/8051.sdb.txt                            |   26 +-
 libr/asm/d/Makefile                                |    5 +-
 libr/asm/d/arm.sdb.txt                             |   17 +
 libr/asm/d/avr.sdb.txt                             |   56 +-
 libr/asm/d/meson.build                             |    3 +-
 libr/asm/d/ppc.sdb.txt                             |  181 +-
 libr/asm/d/sparc.sdb.txt                           |   31 +
 libr/asm/d/v850.sdb.txt                            |   84 +
 libr/asm/meson.build                               |  103 +-
 libr/asm/op.c                                      |   77 +
 ...
 libr/asm/p/asm_x86_nz.c                            |  797 +-
 libr/asm/p/asm_x86_vm.c                            |   46 +-
 libr/asm/p/asm_xap.c                               |   17 +-
 libr/asm/p/asm_xcore_cs.c                          |   23 +-
 libr/asm/p/asm_xtensa.c                            |   52 +-
 libr/asm/p/asm_z80.c                               |    7 +-
 libr/asm/p/cs_mnemonics.c                          |    4 +-
 libr/asm/p/mcore.mk                                |   14 +
 libr/asm/p/pic.mk                                  |    3 +-
 libr/bin/Makefile                                  |    9 +-
 libr/bin/{file.c => bfile.c}                       |  747 +-
 libr/bin/bin.c                                     |  808 +-
 libr/bin/bin_write.c                               |    4 +-
 libr/bin/blang.c                                   |  190 +
 libr/bin/d/Makefile                                |    1 +
 libr/bin/d/dll/aclui.sdb.txt                       |   16 +-
 libr/bin/d/dll/activeds.sdb.txt                    |   58 +-
 libr/bin/d/dll/atl.sdb.txt                         |  108 +-
 libr/bin/d/dll/borlndmm.sdb.txt                    |   30 +-
 libr/bin/d/dll/browseui.sdb.txt                    |    6 +-
 libr/bin/d/dll/comctl32.sdb.txt                    |  236 +-
 libr/bin/d/dll/dsound.sdb.txt                      |   24 +-
 libr/bin/d/dll/mfc120.sdb.txt                      |13242 ++++++++++++
 libr/bin/d/dll/mfc42.sdb.txt                       |12800 ++++++------
 libr/bin/d/dll/mfc42u.sdb.txt                      |12794 ++++++------
 libr/bin/d/dll/mstlsapi.sdb.txt                    |  212 +-
 libr/bin/d/dll/msvbvm50.sdb.txt                    | 1198 +-
 libr/bin/d/dll/odbc32.sdb.txt                      |  350 +-
 libr/bin/d/dll/olecli32.sdb.txt                    |  354 +-
 libr/bin/d/dll/oledlg.sdb.txt                      |   46 +-
 libr/bin/d/dll/olepro32.sdb.txt                    |   22 +-
 libr/bin/d/dll/olesvr32.sdb.txt                    |   44 +-
 libr/bin/d/dll/shdocvw.sdb.txt                     |   48 +-
 libr/bin/d/dll/shell32.sdb.txt                     |  964 +-
 libr/bin/d/dll/shlwapi.sdb.txt                     |  758 +-
 libr/bin/d/dll/uxtheme.sdb.txt                     |  168 +-
 libr/bin/d/dll/vb40032.sdb.txt                     |  444 +-
 libr/bin/d/dll/vssapi.sdb.txt                      |  166 +-
 libr/bin/d/dll/winmm.sdb.txt                       |  384 +-
 libr/bin/d/meson.build                             |    5 +-
 libr/bin/demangle.c                                |  473 +-
 libr/bin/dwarf.c                                   |  190 +-
 libr/bin/filter.c                                  |  161 +-
 libr/bin/format/bflt/bflt.c                        |    4 +-
 libr/bin/format/coff/coff.c                        |   14 +-
 libr/bin/format/dex/dex.c                          |    5 +-
 libr/bin/format/dex/dex.h                          |   20 +-
 libr/bin/format/elf/elf.c                          | 1204 +-
 libr/bin/format/elf/elf.h                          |    8 +-
 libr/bin/format/elf/elf_write.c                    |  112 +-
 libr/bin/format/mach0/dyldcache.c                  |   33 +-
 libr/bin/format/mach0/fatmach0.c                   |    5 +-
 libr/bin/format/mach0/mach0.c                      | 1238 +-
 libr/bin/format/mach0/mach0.h                      |   40 +-
 libr/bin/format/mach0/mach0_defines.h              |   18 +-
 libr/bin/format/mach0/mach0_specs.h                |   55 +
 libr/bin/format/mdmp/mdmp.c                        |  195 +-
 libr/bin/format/mdmp/mdmp.h                        |    3 +-
 libr/bin/format/mdmp/mdmp_pe.c                     |   74 +-
 libr/bin/format/mdmp/mdmp_specs.h                  |   76 +-
 libr/bin/format/mz/mz.c                            |  356 +-
 libr/bin/format/mz/mz.h                            |   17 +-
 libr/bin/format/nxo/nxo.c                          |  172 +
 libr/bin/format/nxo/nxo.h                          |   72 +
 libr/bin/format/objc/mach0_classes.c               |   95 +-
 libr/bin/format/objc/mach0_classes.h               |    1 +
 libr/bin/format/omf/omf.c                          |  152 +-
 libr/bin/format/omf/omf.h                          |    6 +-
 libr/bin/format/p9/p9bin.c                         |   20 +-
 libr/bin/format/pe/pe.c                            |  307 +-
 ...
 libr/bin/mangling/swift-sd.c                       |   58 +-
 libr/bin/mangling/swift.c                          |    8 +-
 libr/bin/meson.build                               |   47 +-
 libr/bin/obj.c                                     |  355 +-
 libr/bin/p/bflt.mk                                 |   13 -
 libr/bin/p/bin_any.c                               |   12 +-
 libr/bin/p/bin_art.c                               |   51 +-
 libr/bin/p/bin_avr.c                               |   27 +-
 libr/bin/p/bin_bf.c                                |    6 +-
 libr/bin/p/bin_bflt.c                              |   16 +-
 libr/bin/p/bin_bios.c                              |   35 +-
 libr/bin/p/bin_bootimg.c                           |   60 +-
 libr/bin/p/bin_cgc.c                               |   18 +-
 libr/bin/p/bin_coff.c                              |   38 +-
 libr/bin/p/bin_dex.c                               |  116 +-
 libr/bin/p/bin_dol.c                               |   31 +-
 libr/bin/p/bin_dyldcache.c                         | 1429 +-
 libr/bin/p/bin_elf.c                               | 1176 +-
 ...
 libr/bin/pdb/pdb_downloader.c                      |   15 +-
 ...
 libr/config.h.in                                   |    2 +
 libr/config.mk.tail                                |    8 +-
 libr/config/config.c                               |   79 +-
 libr/config/meson.build                            |   12 +-
 libr/cons/2048.c                                   |   44 +-
 libr/cons/Makefile                                 |    2 +-
 libr/cons/canvas.c                                 |  516 +-
 libr/cons/canvas_line.c                            |  113 +-
 libr/cons/cons.c                                   |  732 +-
 libr/cons/d/Makefile                               |    9 +-
 libr/cons/d/ayu                                    |   50 +
 libr/cons/d/basic                                  |    7 +-
 ...
 libr/cons/d/meson.build                            |    2 +-
 libr/cons/d/monokai                                |    6 +
 libr/cons/d/ogray                                  |   15 +-
 libr/cons/d/onedark                                |   62 +
 libr/cons/d/pink                                   |   16 +-
 libr/cons/d/rasta                                  |   11 +
 libr/cons/d/sepia                                  |   57 +
 libr/cons/d/smyck                                  |    7 +
 ...
 libr/cons/dietline.c                               |  606 +-
 libr/cons/editor.c                                 |   14 +-
 libr/cons/grep.c                                   |  280 +-
 libr/cons/hud.c                                    |  228 +-
 libr/cons/input.c                                  |  152 +-
 libr/cons/less.c                                   |  201 +-
 libr/cons/line.c                                   |    3 +
 libr/cons/meson.build                              |   12 +-
 libr/cons/more.c                                   |  144 +
 libr/cons/output.c                                 |    4 +-
 ...
 libr/core/anal_tp.c                                |  845 +-
 libr/core/blaze.c                                  |   18 +-
 libr/core/canal.c                                  | 1709 +-
 libr/core/carg.c                                   |   32 +-
 libr/core/{asm.c => casm.c}                        |  127 +-
 libr/core/cbin.c                                   | 1153 +-
 libr/core/cconfig.c                                |  635 +-
 libr/core/{file.c => cfile.c}                      |  205 +-
 libr/core/cio.c                                    |   41 +-
 libr/core/cmd.c                                    |  831 +-
 libr/core/cmd_anal.c                               | 2728 ++-
 libr/core/cmd_api.c                                |  147 +-
 libr/core/cmd_cmp.c                                |   26 +-
 libr/core/cmd_debug.c                              |  907 +-
 libr/core/cmd_eval.c                               |  175 +-
 libr/core/cmd_flag.c                               |   80 +-
 libr/core/cmd_hash.c                               |    6 +-
 libr/core/cmd_help.c                               |  355 +-
 libr/core/cmd_info.c                               |  374 +-
 libr/core/cmd_log.c                                |  129 +-
 libr/core/cmd_magic.c                              |   77 +-
 libr/core/cmd_meta.c                               |  154 +-
 libr/core/cmd_mount.c                              |  112 +-
 libr/core/cmd_open.c                               |  387 +-
 libr/core/cmd_print.c                              | 1467 +-
 libr/core/cmd_project.c                            |    7 +-
 libr/core/cmd_search.c                             | 1100 +-
 libr/core/cmd_search_rop.c                         |    2 +-
 libr/core/cmd_section.c                            |  619 -
 libr/core/cmd_seek.c                               |  176 +-
 libr/core/cmd_type.c                               | 1009 +-
 libr/core/cmd_write.c                              |  226 +-
 libr/core/cmd_zign.c                               |   61 +-
 libr/core/core.c                                   | 1729 +-
 libr/core/{log.c => corelog.c}                     |    0
 libr/core/disasm.c                                 | 1824 +-
 libr/core/fortune.c                                |    4 +-
 libr/core/gdiff.c                                  |   16 +-
 libr/core/graph.c                                  |  743 +-
 libr/core/hack.c                                   |   44 +-
 libr/core/libs.c                                   |   21 +-
 libr/core/linux_heap_glibc.c                       | 1465 +-
 libr/core/linux_heap_jemalloc.c                    |   69 +-
 libr/core/meson.build                              |  102 +-
 libr/core/p/Makefile                               |   14 +-
 libr/core/p/a2f.mk                                 |   15 +
 libr/core/p/anal.mk                                |   15 -
 libr/core/p/{core_anal.c => core_a2f.c}            |   44 +-
 libr/core/p/core_java.c                            |  245 +-
 libr/core/p/core_test.c                            |    2 +-
 libr/core/panels.c                                 | 3810 +++-
 libr/core/patch.c                                  |   15 +-
 libr/core/plugin.c                                 |    8 +-
 libr/core/project.c                                |  124 +-
 libr/core/pseudo.c                                 |   24 +-
 libr/core/rtr.c                                    |  365 +-
 libr/core/task.c                                   |  633 +-
 libr/core/vasm.c                                   |   31 +-
 libr/core/visual.c                                 | 1418 +-
 libr/core/vmenus.c                                 |  816 +-
 libr/core/yank.c                                   |   10 +-
 libr/crypto/Makefile                               |    3 +-
 libr/crypto/crypto.c                               |    6 +-
 libr/{util => crypto}/des.c                        |    1 +
 libr/crypto/meson.build                            |   33 +-
 ...
 libr/debug/debug.c                                 |  144 +-
 libr/debug/dreg.c                                  |   23 +-
 libr/debug/esil.c                                  |   40 +-
 libr/debug/map.c                                   |  288 +-
 libr/debug/meson.build                             |   87 +-
 ...
 libr/debug/p/debug_io.c                            |    8 +-
 libr/debug/p/debug_native.c                        |  298 +-
 libr/debug/p/debug_null.c                          |    2 +-
 libr/debug/p/debug_qnx.c                           |   40 +-
 libr/debug/p/debug_rap.c                           |    4 +-
 libr/debug/p/debug_windbg.c                        |   53 +-
 libr/debug/p/native/bt.c                           |   34 +-
 libr/debug/p/native/bt/fuzzy-all.c                 |   15 +-
 libr/debug/p/native/bt/generic-x86.c               |    4 +-
 libr/debug/p/native/drx.c                          |    2 +-
 libr/debug/p/native/linux/linux_coredump.c         |   40 +-
 libr/debug/p/native/linux/linux_debug.c            |  113 +-
 libr/debug/p/native/linux/reg/linux-arm64.h        |  266 +-
 ...
 libr/debug/trace.c                                 |   31 +-
 libr/egg/egg.c                                     |   71 +-
 libr/egg/egg_Cfile.c                               |   62 +-
 libr/egg/egg_lang.c                                |   41 +-
 libr/egg/emit_trace.c                              |   32 +-
 libr/egg/emit_x86.c                                |  216 +-
 libr/egg/meson.build                               |   21 +-
 libr/egg/p/egg_bind.c                              |    2 +-
 libr/egg/p/egg_exec.c                              |   29 +-
 libr/egg/p/egg_reverse.c                           |    2 +-
 libr/egg/p/egg_shya.c                              |    2 +-
 libr/egg/p/egg_xor.c                               |    2 +-
 libr/egg/rlcc/mpc/mpc.c                            | 7234 +++----
 libr/egg/rlcc/mpc/mpc.h                            |  676 +-
 libr/flag/Makefile                                 |    2 +-
 libr/flag/d/Makefile                               |   23 +
 libr/flag/d/alloc                                  |    5 +
 libr/flag/d/env                                    |    7 +
 libr/flag/d/fs                                     |    4 +
 libr/flag/d/meson.build                            |   28 +
 libr/flag/d/network                                |   10 +
 libr/flag/d/process                                |    2 +
 libr/flag/d/stdout                                 |    2 +
 libr/flag/d/string                                 |    7 +
 libr/flag/flag.c                                   |  280 +-
 libr/flag/meson.build                              |   14 +-
 libr/flag/sort.c                                   |   30 +-
 libr/flag/spaces.c                                 |   43 +-
 libr/flag/tags.c                                   |   53 +
 libr/flag/zones.c                                  |   12 +-
 libr/fs/Makefile                                   |    4 +-
 libr/fs/fs.c                                       |  247 -
 libr/fs/meson.build                                |   26 +-
 libr/fs/p/fs_io.c                                  |    2 +-
 ...
 libr/hash/md5.c                                    |   41 +-
 libr/hash/md5.h                                    |    8 +
 libr/hash/meson.build                              |   32 +-
 libr/hash/sha2.c                                   |   29 +-
 libr/hash/state.c                                  |   44 +-
 libr/hash/xxhash.c                                 |   10 +-
 libr/hash/xxhash.h                                 |    2 +-
 libr/include/btree.h                               |   37 -
 libr/include/msvc/unistd.h                         |    4 +-
 libr/include/r_anal.h                              |  355 +-
 libr/include/r_asm.h                               |  138 +-
 libr/include/r_bin.h                               |  334 +-
 libr/include/r_bind.h                              |    4 +
 libr/include/r_binheap.h                           |   14 +-
 libr/include/r_bp.h                                |   22 +-
 libr/include/r_cmd.h                               |   10 +-
 libr/include/r_config.h                            |    2 +-
 libr/include/r_cons.h                              |  212 +-
 libr/include/r_core.h                              |  226 +-
 libr/include/r_crypto.h                            |    5 +-
 libr/include/{r_util => r_crypto}/r_des.h          |    8 +-
 libr/include/r_debug.h                             |   26 +-
 libr/include/r_diff.h                              |    3 +-
 libr/include/r_endian.h                            |   22 +-
 libr/include/r_flag.h                              |   36 +-
 libr/include/r_fs.h                                |    2 +
 ...
 libr/include/r_parse.h                             |   13 +-
 libr/include/r_reg.h                               |    7 +-
 libr/include/r_search.h                            |    2 +-
 libr/include/r_sign.h                              |   24 +-
 libr/include/r_slist.h                             |   45 -
 libr/include/r_socket.h                            |   20 +-
 libr/include/r_syscall.h                           |    1 +
 libr/include/r_th.h                                |   43 +-
 libr/include/r_types.h                             |  120 +-
 libr/include/r_types_base.h                        |   21 +-
 libr/include/r_userconf.h.acr                      |   78 +-
 libr/include/r_userconf.h.in                       |   34 -
 libr/include/r_util.h                              |   11 +-
 libr/include/r_util/r_ascii_table.h                |    2 +-
 libr/include/r_util/r_asn1.h                       |   19 +-
 libr/include/r_util/r_assert.h                     |  117 +
 libr/include/r_util/r_buf.h                        |    5 +
 libr/include/r_util/r_cache.h                      |    2 +
 libr/include/r_util/r_ctypes.h                     |   49 +
 libr/include/r_util/r_event.h                      |   42 +
 libr/include/r_util/r_file.h                       |    1 +
 libr/include/r_util/r_id_storage.h                 |   50 -
 libr/include/r_util/r_idpool.h                     |   79 +
 ...
 libr/include/r_util/r_num.h                        |   10 +-
 libr/include/r_util/r_panels.h                     |   19 +-
 libr/include/r_util/r_pkcs7.h                      |    2 +-
 libr/include/{ => r_util}/r_print.h                |   35 +-
 libr/include/r_util/r_sandbox.h                    |   12 +
 libr/include/r_util/r_signal.h                     |    9 +
 libr/include/r_util/r_str.h                        |   20 +-
 libr/include/r_util/r_str_util.h                   |   19 +-
 libr/include/r_util/r_strbuf.h                     |    8 +-
 libr/include/r_util/r_sys.h                        |   35 +-
 ...
 libr/include/sdb/dict.h                            |    2 +
 libr/include/sdb/ht.h                              |   72 -
 ...
 libr/io/map.c                                      |  126 +-
 libr/io/meson.build                                |   48 +-
 libr/io/p/io_ar.c                                  |    2 +-
 libr/io/p/io_bfdbg.c                               |   69 +-
 libr/io/p/io_bochs.c                               |   15 +-
 libr/io/p/io_debug.c                               |  163 +-
 libr/io/p/io_default.c                             |   62 +-
 libr/io/p/io_gdb.c                                 |   22 +-
 libr/io/p/io_gprobe.c                              |  115 +-
 libr/io/p/io_gprobe.h                              |   22 +
 libr/io/p/io_gzip.c                                |    6 +-
 libr/io/p/io_http.c                                |   18 +-
 libr/io/p/io_ihex.c                                |   38 +-
 ...
 libr/io/undo.c                                     |   34 +-
 libr/lang/lang.c                                   |   31 +-
 libr/lang/meson.build                              |   28 +-
 libr/lang/p/c.c                                    |    9 +-
 libr/lang/p/cpipe.c                                |   19 +-
 libr/lang/p/pipe.c                                 |   17 +-
 libr/lang/p/rust.c                                 |   31 +-
 libr/lang/p/vala.c                                 |   47 +-
 libr/lang/p/zig.c                                  |  108 +
 libr/ld.script                                     |    6 +
 libr/libs.custom.mk.example                        |   10 +
 libr/libs.mk                                       |   16 +
 libr/magic/Makefile                                |    5 +-
 libr/magic/apprentice.c                            |  452 +-
 libr/magic/ascmagic.c                              |  238 +-
 libr/magic/d/default/{macintosh => apple}          |   12 +
 libr/magic/d/default/{OpenBSD => openbsd}          |    0
 libr/magic/d/meson.build                           |    2 +-
 ...
 libr/meson.build                                   |  116 +-
 libr/parse/Makefile                                |   10 +-
 libr/parse/code.c                                  |   23 +-
 libr/parse/meson.build                             |   32 +-
 libr/parse/p/avr_pseudo.mk                         |   28 +-
 libr/parse/p/parse_6502_pseudo.c                   |   33 +-
 libr/parse/p/parse_arm_pseudo.c                    |   95 +-
 libr/parse/p/parse_att2intel.c                     |   46 +-
 libr/parse/p/parse_avr_pseudo.c                    |  460 +-
 ...
 libr/parse/parse.c                                 |  211 +-
 libr/reg/arena.c                                   |  118 +-
 libr/reg/cond.c                                    |  121 +-
 libr/reg/double.c                                  |   10 +-
 libr/reg/meson.build                               |   10 +-
 ...
 libr/syscall/d/meson.build                         |   41 +-
 libr/syscall/d/s110-arm-16.sdb.txt                 |  146 +
 libr/syscall/fastcall.h                            |    4 +-
 libr/syscall/meson.build                           |   13 +-
 libr/syscall/syscall.c                             |  100 +-
 libr/util/Makefile                                 |   37 +-
 libr/util/asn1.c                                   |  467 +
 libr/util/{r_oids.h => asn1_oids.h}                | 4591 ++---
 libr/util/assert.c                                 |   35 +
 libr/util/astr.c                                   |  383 +
 ...
 libr/util/ctype.c                                  |  625 +
 libr/util/{p_date.c => date.c}                     |   61 +-
 libr/util/deps.mk                                  |    2 +-
 libr/util/diff.c                                   |   78 +-
 libr/util/event.c                                  |   83 +
 libr/util/file.c                                   |  198 +-
 libr/util/flist.c                                  |   12 +-
 libr/util/{p_format.c => format.c}                 |  594 +-
 libr/util/graph.c                                  |   30 +-
 libr/util/hex.c                                    |  147 +-
 libr/util/iconv.c                                  |   35 -
 libr/util/idpool.c                                 |  372 +-
 libr/util/json_indent.c                            |    3 +-
 libr/util/lib.c                                    |   24 +-
 libr/util/list.c                                   |  449 +-
 libr/util/log.c                                    |  155 +-
 libr/util/mem.c                                    |   13 +
 libr/util/meson.build                              |   54 +-
 libr/util/mixed.c                                  |  302 -
 libr/util/name.c                                   |   37 +-
 libr/util/pie.c                                    |   92 +
 libr/util/{r_pkcs7.c => pkcs7.c}                   |  353 +-
 libr/util/pool.c                                   |   15 +-
 libr/util/print.c                                  |  207 +-
 libr/util/queue.c                                  |    6 +-
 libr/util/r_asn1.c                                 |  590 -
 libr/util/r_asn1_internal.h                        |   10 -
 libr/util/r_json.c                                 |   32 +-
 libr/util/r_pkcs7_internal.h                       |   38 -
 libr/util/r_x509_internal.h                        |   38 -
 libr/util/randomart.c                              |   14 +-
 libr/util/range.c                                  |    3 +-
 libr/util/rbtree.c                                 |    2 +-
 ...
 libr/util/unum.c                                   |  349 +-
 libr/util/utf8.c                                   |   93 +-
 libr/util/vector.c                                 |  377 +-
 libr/util/{r_x509.c => x509.c}                     |  400 +-
 libr/util/x509.h                                   |   26 +
 libr/util/zip.c                                    |    6 +-
 man/rabin2.1                                       |    4 +-
 man/radare2.1                                      |    2 +-
 ...
 shlr/capstone-patches/capstone-calloc.patch        |   25 +-
 ...
 shlr/java/code.h                                   |    5 +-
 shlr/java/dsojson.c                                |  119 +-
 shlr/java/dsojson.h                                |  106 +-
 shlr/java/ops.c                                    |  594 +-
 shlr/meson.build                                   |  789 +-
 ...
 shlr/sdb/src/Makefile                              |    7 +-
 shlr/sdb/src/array.c                               |   87 +-
 shlr/sdb/src/base64.c                              |    8 +-
 shlr/sdb/src/dict.c                                |   66 +-
 shlr/sdb/src/dict.h                                |    2 +
 shlr/sdb/src/disk.c                                |   62 +-
 shlr/sdb/src/fmt.c                                 |   41 +-
 shlr/sdb/src/ht.c                                  |  309 -
 shlr/sdb/src/ht.h                                  |   72 -
 ...
 shlr/sdb/src/journal.c                             |    5 +-
 shlr/sdb/src/json.c                                |    9 +-
 shlr/sdb/src/json/api.c                            |    1 -
 shlr/sdb/src/json/indent.c                         |    4 +-
 shlr/sdb/src/json/js0n.c                           |    7 +-
 shlr/sdb/src/json/json.h                           |   19 -
 shlr/sdb/src/json/path.c                           |   10 +-
 shlr/sdb/src/ls.h                                  |    3 +-
 shlr/sdb/src/main.c                                |    1 +
 shlr/sdb/src/num.c                                 |    4 +-
 shlr/sdb/src/query.c                               |   42 +-
 shlr/sdb/src/sdb.c                                 |  307 +-
 shlr/sdb/src/sdb.h                                 |  141 +-
 shlr/sdb/src/sdbht.c                               |   68 +-
 shlr/sdb/src/sdbht.h                               |   49 +-
 shlr/sdb/src/util.c                                |   27 +-
 shlr/spp/Makefile                                  |    2 +
 shlr/spp/p/cpp.h                                   |    2 +-
 shlr/spp/p/spp.h                                   |    4 +-
 shlr/spp/r_api.h                                   |   19 +-
 ...
 shlr/tcc/libtcc.c                                  |    1 +
 shlr/tcc/tcc.h                                     |    5 +
 shlr/tcc/tccgen.c                                  |  444 +-
 shlr/tcc/tccpp.c                                   |   79 +-
 shlr/windbg/profiles.h                             |   42 +-
 shlr/windbg/windbg.c                               |   78 +-
 shlr/windbg/windbg.h                               |   16 +
 shlr/www/enyo/disassembler_old.js                  |    2 +-
 shlr/www/enyo/vendors/jquery.layout-latest.min.js  |  282 +-
 shlr/www/enyo/vendors/jquery.scrollTo.min.js       |   12 +-
 shlr/www/f/index.html                              |    2 +-
 shlr/www/graph/index.html                          |   50 +-
 shlr/www/graph/js-graph-it.css                     |   42 +-
 shlr/www/graph/sf-homepage.css                     |  238 +-
 shlr/www/index.html                                |   12 +-
 shlr/www/m/app.js                                  |    4 +-
 shlr/www/p/vendors/jquery.layout-latest.min.js     |  282 +-
 shlr/www/p/vendors/layout-default-latest.css       |  446 +-
 snapcraft.yaml                                     |   62 +
 sys/android-build.sh                               |   32 +-
 ...
 sys/ios-sdk.sh                                     |  223 +-
 sys/ios-shell.sh                                   |   12 -
 sys/ios-simulator.sh                               |   13 +-
 sys/ios-static.sh                                  |   11 +-
 sys/macos-cert.sh                                  |   60 +
 sys/menu.sh                                        |    9 +-
 sys/meson-sdk.sh                                   |   37 +
 sys/meson.py                                       |  162 +-
 sys/ndk-gcc                                        |  120 -
 ...
 travis-script                                      |   58 +
 1198 files changed, 147639 insertions(+), 79378 deletions(-)
 ...
 delete mode 100644 libr/anal/ref.c
 delete mode 100644 libr/anal/types.c
 ...
 create mode 100644 libr/asm/arch/pic/pic_midrange.c
 create mode 100644 libr/asm/arch/pic/pic_midrange.h
 ...
 rename libr/bin/{file.c => bfile.c} (54%)
 create mode 100644 libr/bin/blang.c
 create mode 100644 libr/bin/d/dll/mfc120.sdb.txt
 create mode 100644 libr/bin/format/nxo/nxo.c
 create mode 100644 libr/bin/format/nxo/nxo.h
 ...
 create mode 100644 libr/cons/d/bold
 create mode 100644 libr/cons/d/onedark
 create mode 100644 libr/cons/d/sepia
 ...
 rename libr/core/{asm.c => casm.c} (91%)
 rename libr/core/{file.c => cfile.c} (86%)
 ...
 rename libr/core/p/{core_anal.c => core_a2f.c} (90%)
 rename libr/{util => crypto}/des.c (99%)
 create mode 100644 libr/debug/p/native/reg/kfbsd-arm64.h
 create mode 100644 libr/flag/d/Makefile
 create mode 100644 libr/flag/d/alloc
 create mode 100644 libr/flag/d/env
 create mode 100644 libr/flag/d/fs
 create mode 100644 libr/flag/d/meson.build
 create mode 100644 libr/flag/d/network
 create mode 100644 libr/flag/d/process
 create mode 100644 libr/flag/d/stdout
 create mode 100644 libr/flag/d/string
 create mode 100644 libr/flag/tags.c
 create mode 100644 libr/fs/shell.c
 ...
 create mode 100644 libr/include/r_util/r_ctypes.h
 create mode 100644 libr/include/r_util/r_event.h
 delete mode 100644 libr/include/r_util/r_id_storage.h
 create mode 100644 libr/include/r_util/r_idpool.h
 delete mode 100644 libr/include/r_util/r_mixed.h
 rename libr/include/{ => r_util}/r_print.h (89%)
 ...
 create mode 100644 libr/io/p/io_gprobe.h
 create mode 100644 libr/lang/p/zig.c
 create mode 100644 libr/ld.script
 ...
 create mode 100644 libr/util/asn1.c
 rename libr/util/{r_oids.h => asn1_oids.h} (94%)
 create mode 100644 libr/util/assert.c
 create mode 100644 libr/util/astr.c
 delete mode 100644 libr/util/btree.c
 create mode 100644 libr/util/ctype.c
 rename libr/util/{p_date.c => date.c} (69%)
 create mode 100644 libr/util/event.c
 rename libr/util/{p_format.c => format.c} (84%)
 delete mode 100644 libr/util/iconv.c
 delete mode 100644 libr/util/mixed.c
 create mode 100644 libr/util/pie.c
 rename libr/util/{r_pkcs7.c => pkcs7.c} (68%)
 delete mode 100644 libr/util/r_asn1.c
 delete mode 100644 libr/util/r_asn1_internal.h
 delete mode 100644 libr/util/r_pkcs7_internal.h
 delete mode 100644 libr/util/r_x509_internal.h
 rename libr/util/{p_seven.c => seven.c} (98%)
 ...
 rename libr/util/{r_x509.c => x509.c} (71%)
 create mode 100644 libr/util/x509.h
 delete mode 100644 man/ragg2-cc.1
 mode change 100755 => 100644 mk/platform.mk
 ...
 delete mode 100644 shlr/sdb/src/json/json.h
 ...
 delete mode 100755 sys/ios-shell.sh
 create mode 100755 sys/macos-cert.sh
 ...
 create mode 100755 sys/ref.sh
 create mode 100755 sys/release-notes.sh
 create mode 100755 sys/release.sh
...
SHARED: io.shm
STATIC: anal.6502 anal.8051 anal.arc anal.arm_cs anal.arm_gnu anal.avr anal.bf anal.chip8 anal.cr16 anal.cris anal.dalvik anal.ebc anal.gb anal.h8300 anal.o
...
CC signal.c
CC syscmd.c
/tmp/ccfTRFu3.s: Assembler messages:
/tmp/ccfTRFu3.s:715: Error: selected processor does not support ARM mode `bkpt $0'
