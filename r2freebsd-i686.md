Problem description:
```
After R2CON it is my first day to pull the r2 git,
and start to compile and BOOM the error happened, compilation stopped.
Never see this one before, please see the collowing compile log for details..
```
Compile log:
```asm
$ uname -a 
...
CC zip_add_dir.c
CC zip_add_entry.c
In file included from ../include/zipconf.h:16,
                 from ../include/zip.h:58,
                 from zipint.h:53,
                 from zip_add.c:37:
../../../libr/include/r_types.h:212: error: expected ';', ',' or ')' before 'str'
In file included from ../include/zipconf.h:16,
                 from ../include/zip.h:58,
                 from zipint.h:53,
...
../../../libr/include/r_types.h:212: error: expected ';', ',' or ')' before 'str'
CC zip_close.c
gmake[2]: *** [/usr/home/test/radare/radare2/libr/../global.mk:42: zip_add_entry.o] Error 1
gmake[2]: *** Waiting for unfinished jobs....
gmake[2]: *** [/usr/home/test/radare/radare2/libr/../global.mk:42: zip_add_dir.o] Error 1
gmake[2]: *** [/usr/home/test/radare/radare2/libr/../global.mk:42: zip_add.o] Error 1
In file included from ../include/zipconf.h:16,
                 from ../include/zip.h:58,
                 from zipint.h:53,
                 from zip_close.c:36:
../../../libr/include/r_types.h:212: error: expected ';', ',' or ')' before 'str'
gmake[2]: *** [/usr/home/test/radare/radare2/libr/../global.mk:42: zip_close.o] Error 1
gmake[1]: *** [Makefile:25: zip/libr_zip.a] Error 2
gmake: *** [Makefile:57: all] Error 2

$ date
Sat Sep 15 20:34:06 JST 2018
```
End of report
